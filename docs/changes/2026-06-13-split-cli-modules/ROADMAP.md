...
|---|---|---|---|---|
| R-1 | Historical packet | `split-cli-modules` was an earlier docdev maintenance packet | `docs/changes/2026-06-13-split-cli-modules/` | Preserve as a concise English archive summary |
