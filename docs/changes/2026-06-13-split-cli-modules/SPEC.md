...
| Packet | `docs/changes/2026-06-13-split-cli-modules/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-13 |

## 1. One-Sentence Goal

Preserve the durable intent of the `split-cli-modules` change packet in concise English so
