...
| Packet | `docs/changes/2026-06-24-skill-surface-hide-wrapper-history/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-24 |

## 1. One-Sentence Goal

Preserve the durable intent of the `skill-surface-hide-wrapper-history` change packet in concise English so
