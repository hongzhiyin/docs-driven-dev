...
| Packet | `docs/changes/2026-06-18-remove-wrapper-residual-guidance/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-18 |

## 1. One-Sentence Goal

Preserve the durable intent of the `remove-wrapper-residual-guidance` change packet in concise English so
