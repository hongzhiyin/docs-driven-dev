...
|---|---|---|---|---|
| R-1 | Historical packet | `remove-wrapper-residual-guidance` was an earlier docdev maintenance packet | `docs/changes/2026-06-18-remove-wrapper-residual-guidance/` | Preserve as a concise English archive summary |
