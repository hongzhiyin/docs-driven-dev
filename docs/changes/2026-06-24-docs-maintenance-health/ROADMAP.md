...
|---|---|---|---|---|
| R-1 | Historical packet | `docs-maintenance-health` was an earlier docdev maintenance packet | `docs/changes/2026-06-24-docs-maintenance-health/` | Preserve as a concise English archive summary |
