...
|---|---|---|---|---|
| R-1 | Historical packet | `native-installer-distribution` was an earlier docdev maintenance packet | `docs/changes/2026-06-11-native-installer-distribution/` | Preserve as a concise English archive summary |
