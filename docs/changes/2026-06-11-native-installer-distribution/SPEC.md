...
| Packet | `docs/changes/2026-06-11-native-installer-distribution/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-11 |

## 1. One-Sentence Goal

Preserve the durable intent of the `native-installer-distribution` change packet in concise English so
