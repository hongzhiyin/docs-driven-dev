...
This file preserves the architectural role of the `native-installer-distribution` packet after the
...
| Area | Archived Role |
|---|---|
| Packet directory | Historical work context under `docs/changes/2026-06-11-native-installer-distribution/` |
