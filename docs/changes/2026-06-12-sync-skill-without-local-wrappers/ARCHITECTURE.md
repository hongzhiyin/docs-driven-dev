# ARCHITECTURE - Sync Skill Without Local Wrappers

> Archived English summary for a historical docdev change packet.

## 1. Scope

This file preserves the architectural role of the `sync-skill-without-local-wrappers` packet after the
...
| Area | Archived Role |
|---|---|
| Packet directory | Historical work context under `docs/changes/2026-06-12-sync-skill-without-local-wrappers/` |
