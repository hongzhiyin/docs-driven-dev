# DECISIONS - Sync Skill Without Local Wrappers
...
**Context**:
The `sync-skill-without-local-wrappers` packet was created on 2026-06-12 as part of earlier docdev maintenance.
