# SPEC - Sync Skill Without Local Wrappers
...
| Packet | `docs/changes/2026-06-12-sync-skill-without-local-wrappers/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-12 |

## 1. One-Sentence Goal

Preserve the durable intent of the `sync-skill-without-local-wrappers` change packet in concise English so
