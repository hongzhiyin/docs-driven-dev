# SPEC - Windows Bare Command Install
...
| Packet | `docs/changes/2026-06-15-windows-bare-command-install/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-15 |

## 1. One-Sentence Goal

Preserve the durable intent of the `windows-bare-command-install` change packet in concise English so
