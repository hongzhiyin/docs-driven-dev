# ROADMAP - Windows Bare Command Install
...
|---|---|---|---|---|
| R-1 | Historical packet | `windows-bare-command-install` was an earlier docdev maintenance packet | `docs/changes/2026-06-15-windows-bare-command-install/` | Preserve as a concise English archive summary |
