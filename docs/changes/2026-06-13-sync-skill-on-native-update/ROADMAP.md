# ROADMAP - Sync Skill On Native Update
...
|---|---|---|---|---|
| R-1 | Historical packet | `sync-skill-on-native-update` was an earlier docdev maintenance packet | `docs/changes/2026-06-13-sync-skill-on-native-update/` | Preserve as a concise English archive summary |
