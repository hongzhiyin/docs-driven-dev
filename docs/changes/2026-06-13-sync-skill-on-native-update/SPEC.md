# SPEC - Sync Skill On Native Update
...
| Packet | `docs/changes/2026-06-13-sync-skill-on-native-update/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-13 |

## 1. One-Sentence Goal

Preserve the durable intent of the `sync-skill-on-native-update` change packet in concise English so
