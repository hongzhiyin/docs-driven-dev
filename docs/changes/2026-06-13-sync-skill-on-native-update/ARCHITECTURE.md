# ARCHITECTURE - Sync Skill On Native Update

> Archived English summary for a historical docdev change packet.

## 1. Scope

This file preserves the architectural role of the `sync-skill-on-native-update` packet after the
...
| Area | Archived Role |
|---|---|
| Packet directory | Historical work context under `docs/changes/2026-06-13-sync-skill-on-native-update/` |
