...
| Packet | `docs/changes/2026-06-16-claude-copy-sync/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-16 |

## 1. One-Sentence Goal

Preserve the durable intent of the `claude-copy-sync` change packet in concise English so
