...
|---|---|---|---|---|
| R-1 | Historical packet | `claude-copy-sync` was an earlier docdev maintenance packet | `docs/changes/2026-06-16-claude-copy-sync/` | Preserve as a concise English archive summary |
