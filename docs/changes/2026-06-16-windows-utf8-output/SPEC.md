...
| Packet | `docs/changes/2026-06-16-windows-utf8-output/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-16 |

## 1. One-Sentence Goal

Preserve the durable intent of the `windows-utf8-output` change packet in concise English so
