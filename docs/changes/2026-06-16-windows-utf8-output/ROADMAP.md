...
|---|---|---|---|---|
| R-1 | Historical packet | `windows-utf8-output` was an earlier docdev maintenance packet | `docs/changes/2026-06-16-windows-utf8-output/` | Preserve as a concise English archive summary |
