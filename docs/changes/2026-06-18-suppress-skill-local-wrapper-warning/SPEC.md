...
| Packet | `docs/changes/2026-06-18-suppress-skill-local-wrapper-warning/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-18 |

## 1. One-Sentence Goal

Preserve the durable intent of the `suppress-skill-local-wrapper-warning` change packet in concise English so
