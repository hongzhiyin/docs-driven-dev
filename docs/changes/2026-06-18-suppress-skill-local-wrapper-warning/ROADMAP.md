...
|---|---|---|---|---|
| R-1 | Historical packet | `suppress-skill-local-wrapper-warning` was an earlier docdev maintenance packet | `docs/changes/2026-06-18-suppress-skill-local-wrapper-warning/` | Preserve as a concise English archive summary |
