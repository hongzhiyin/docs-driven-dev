...
|---|---|---|---|---|
| R-1 | Historical packet | `delegation-guidance` was an earlier docdev maintenance packet | `docs/changes/2026-06-18-delegation-guidance/` | Preserve as a concise English archive summary |
