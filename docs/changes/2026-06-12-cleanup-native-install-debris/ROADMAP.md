# ROADMAP - Cleanup Native Install Debris
...
|---|---|---|---|---|
| R-1 | Historical packet | `cleanup-native-install-debris` was an earlier docdev maintenance packet | `docs/changes/2026-06-12-cleanup-native-install-debris/` | Preserve as a concise English archive summary |
