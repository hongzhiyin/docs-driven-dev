# SPEC - Cleanup Native Install Debris
...
| Packet | `docs/changes/2026-06-12-cleanup-native-install-debris/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-12 |

## 1. One-Sentence Goal

Preserve the durable intent of the `cleanup-native-install-debris` change packet in concise English so
