...
This file preserves the architectural role of the `native-uninstall-command` packet after the
...
| Area | Archived Role |
|---|---|
| Packet directory | Historical work context under `docs/changes/2026-06-13-native-uninstall-command/` |
