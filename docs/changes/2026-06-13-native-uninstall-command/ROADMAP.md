...
|---|---|---|---|---|
| R-1 | Historical packet | `native-uninstall-command` was an earlier docdev maintenance packet | `docs/changes/2026-06-13-native-uninstall-command/` | Preserve as a concise English archive summary |
