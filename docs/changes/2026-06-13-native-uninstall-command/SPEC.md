...
| Packet | `docs/changes/2026-06-13-native-uninstall-command/` |
| Last updated | 2026-06-25 |
| Original packet date | 2026-06-13 |

## 1. One-Sentence Goal

Preserve the durable intent of the `native-uninstall-command` change packet in concise English so
