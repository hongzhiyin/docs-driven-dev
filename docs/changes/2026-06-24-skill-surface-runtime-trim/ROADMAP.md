...
|---|---|---|---|---|
| R-1 | Historical packet | `skill-surface-runtime-trim` was an earlier docdev maintenance packet | `docs/changes/2026-06-24-skill-surface-runtime-trim/` | Preserve as a concise English archive summary |
